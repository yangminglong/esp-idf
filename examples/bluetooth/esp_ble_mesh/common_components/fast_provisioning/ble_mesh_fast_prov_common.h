...
#define ESP_BLE_MESH_VND_MODEL_OP_FAST_PROV_NODE_INFO_GET       ESP_BLE_MESH_MODEL_OP_3(0x0A, CID_ESP)
#define ESP_BLE_MESH_VND_MODEL_OP_FAST_PROV_NODE_INFO_STATUS    ESP_BLE_MESH_MODEL_OP_3(0x0B, CID_ESP)
